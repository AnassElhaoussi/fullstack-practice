...
const Login = () => {
  ...
  return (
    <Flex height='100vh'>
      <Stack width='50%' justifyContent='center' alignItems='start' px={20} py={8} spacing={10}>
        <Flex flexDirection='column' alignItems='start' gap='1rem'>
          <FontAwesomeIcon icon={faRightToBracket} className='text-2xl text-red-400' />
          <Heading as='h2' size='lg' fontWeight='extrabold'>Login to your account</Heading>
          <Divider borderColor='red' border='8px' borderRadius='1rem' width='10%' />
        </Flex>
        <Stack gap='0.3rem'>
          <InputGroup>
            <InputLeftElement children={<FontAwesomeIcon icon={faUser} />} />
            <Input placeholder='Enter your username' type='text' focusBorderColor='red.400' />
          </InputGroup>
          <InputGroup>
            <InputLeftElement children={<FontAwesomeIcon icon={faEnvelope} />} />
            <Input placeholder='Enter your email'type='text' focusBorderColor='red.400' />
          </InputGroup>
          <InputGroup>
            <InputLeftElement children={<FontAwesomeIcon icon={faLock} />} />
            <Input placeholder='Enter your password' 
            type={isPasswordShown ? 'text' : 'password'} focusBorderColor='red.400' />
            <InputRightElement 
          ...
          <Heading as='p' size='xs' fontWeight={400} color='gray.500' paddingTop={1}>
